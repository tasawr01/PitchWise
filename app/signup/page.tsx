        ...
        <div className="min-h-screen flex font-sans">
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-3 p-3 bg-gray-50 rounded-md border border-gray-200 text-xs text-gray-600">
                                            ...
                                            <ul className="space-y-1">
                                                <li className={`flex items-center gap-2 ${formData.password.length >= 8 && formData.password.length <= 16 ? 'text-green-600 font-medium' : ''}`}>
                                                    <span className="w-4">{formData.password.length >= 8 && formData.password.length <= 16 ? '✓' : '•'}</span>
                    ...
                    <div className="max-w-3xl w-full animate-fade-in-up">
                        ...
                        <div className="text-center space-y-6">
                            ...
                            <p className="text-lg text-white/70 font-light tracking-wide drop-shadow" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
                                Professional investment networking platform
                            </p>
                        </div>
            ...
            {showSuccessModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fadeIn">
                    <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full overflow-hidden relative flex flex-col items-center p-8 text-center animate-scaleIn border border-white/20">
                        {/* Status Icon */}
                        <div className="w-20 h-20 bg-yellow-50 rounded-full flex items-center justify-center mb-5 relative">
                        ...
                        <h3 className="text-2xl font-extrabold text-[#0B2C4A] mb-3 tracking-tight">Registration Received!</h3>

                        <div className="space-y-3 mb-6">
                            <p className="text-gray-600 text-base leading-relaxed">
                                Thank you for signing up. <strong>Check your email and verify your account.</strong>
                            </p>
                            <p className="text-xs text-gray-500 bg-blue-50 px-3 py-2 rounded-xl border border-blue-100">
                                <strong>Important:</strong> Admin approval will only proceed after you successfully complete the email verification. Please check your inbox and click the verification link.
                            </p>
                            <p className="text-xs text-gray-500 bg-gray-50 px-3 py-2 rounded-xl border border-gray-100">
                                After verification, your account will be <span className="font-bold text-yellow-600">Pending Approval</span>. Our Admin team reviews all new accounts to ensure the quality of our community. This usually takes <strong>1-24 hours</strong>. You will be notified via email once approved.
                            </p>
                        </div>
                        ...
                        <div className="w-full">
                            <Link
                                href="/login"
                                className="block w-full py-3 bg-[#0B2C4A] text-white font-bold rounded-xl hover:bg-[#09223a] transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5 text-base"
                            >
