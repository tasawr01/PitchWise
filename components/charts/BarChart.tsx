...
export default function BarChart({
  ...
  return (
    <div
      className="w-full h-full flex items-end justify-between space-x-2 pt-6 relative"
      ...
      {data.map((d, i) => {
        ...
        return (
          ...
          >
            {/* Bar */}
            <div
              className="w-full max-w-10 rounded-t-lg transition-all duration-300 relative"
              style={{
