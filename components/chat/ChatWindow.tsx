        ...
        if (msg.type === 'file' && msg.fileUrl) {
            return (
                <a
                    ...
                    className={`flex items-center gap-2 px-3 py-2 rounded-lg max-w-[220px] transition-colors ${isOwn ? 'bg-blue-700 hover:bg-blue-800' : 'bg-gray-100 hover:bg-gray-200'
                        }`}
                >
