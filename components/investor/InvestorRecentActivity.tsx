...
// Shared Dummy Data for Investors
const initialActivities = [
    { id: 1, text: "Your proposal for 'TechNova' was accepted", time: "2h ago", type: "success" },
    { id: 2, text: "New pitch 'GreenEnergy' matches your criteria", time: "5h ago", type: "info" },
    { id: 3, text: "You viewed 'AI Health' pitch deck", time: "1d ago", type: "view" },
    { id: 4, text: "Message from Entrepreneur Sarah", time: "2d ago", type: "message" },
];

const allActivities = [
    ...initialActivities,
    { id: 5, text: "Deal with 'EduTech' moved to negotiation", time: "3d ago", type: "success" },
    { id: 6, text: "Added 'Solarify' to watchlist", time: "4d ago", type: "info" },
    { id: 7, text: "You updated your investment preferences", time: "5d ago", type: "info" },
    { id: 8, text: "Welcome to PitchWise Investor Panel!", time: "1w ago", type: "success" },
];

export default function InvestorRecentActivity() {
                    ...
                    >
                        ...
                        <div className="px-8 py-6 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
                            <div>
                                ...
                                <p className="text-sm text-gray-500 mt-1">History of your interactions and updates.</p>
                            </div>
                            <button
